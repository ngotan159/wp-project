                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <figure class="post-thumbnail">
                                                <a href="<?php the_permalink(); ?>" class="post-thumbnail custom-thumbnail" >
                                                    <?php 
...
<div class="col-md-7 blog-item-text">
                                            <article class="post">
                                                <header class="entry-header">
                                                    <h3 class="entry-title custom-title">
                                                        <a href="<?php the_permalink(); ?>"><?php the_title(); ?></a>
                                                    </h3>
                                                    <div class="entry-excerpt custom-font">
                                                        <?php the_excerpt(); ?>
                                                    </div>
                                                    <div class="read-more">
...
<?php } // Đóng if( $ed_blog && ( $blog_heading || $sub_title || $qry->have_posts() )) 
